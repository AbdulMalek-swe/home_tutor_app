                        ...
                        <div className='border-2 relative '>
                            ...
                            <div className='flex items-center justify-center'>
                                <ul className='pt-20 '>
                                    ...
                                    <Link to="/tutor/dashboard" className='flex items-center mt-5 text-blue-800 text-lg'>
                                        <AiOutlineDashboard />
                                        <button className='mx-2  hover:underline hover:opacity-90'>
                                            Dashboard </button>
                                    </Link>
                                    <Link to="/tutor/dashboard" className='flex items-center mt-2 text-blue-800 text-lg mt-5'>
                                        <AiOutlineDashboard />
                                        <button className='mx-2  hover:underline hover:opacity-90'>
                                            Profile </button>
                                    </Link>
